...
APPNAME=altia-mtb-example-psoc6-multiindustry
...
LDFLAGS=$(HMI_DIR)/out/reflash/$(HMI)/altia_table_bin.o $(HMI_DIR)/out/reflash/$(HMI)/images/altia_images_bin.o $(HMI_DIR)/out/reflash/$(HMI)/fonts/altia_fonts_bin.o
